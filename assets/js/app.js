...
async function loadProducts() {
    try {
        ...
        showNotification('error', 'Gagal Memuat Produk', error.message || 'Periksa koneksi internet');
    }
}
...
function editProduct(productId) {
    ...
    preview.src = buildImageUrl(product.image);
    ...
    productsToShow.forEach(product => {
        ...
        productCard.innerHTML = `
            ...
            <img src="${imageUrl}" 
                 alt="${product.name}" 
                 loading="lazy" 
                 onerror="this.src='data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 width=%22400%22 height=%22300%22%3E%3Crect fill=%22%23f0f0f0%22 width=%22400%22 height=%22300%22/%3E%3Ctext x=%2250%25%22 y=%2250%25%22 text-anchor=%22middle%22 fill=%22%23999%22%3EGambar Error%3C/text%3E%3C/svg%3E';">
